...
public class Constants {
	...
	public enum SalaryRange {
		ONE_TO_THREE_LAKH("2500-3500dh"),
		THREE_TO_SIX_LAKH("3500-5000dh"),
		SIX_TO_TWELVE_LAKH("5000-7500dh"),
		TWELVE_TO_EIGHTEEN_LAKH("7500-9000dh"),
		EIGHTEEN_TO_TWENTY_FIVE_LAKH("9000-13000"),
		MORE_THEN_TWENTY_FIVE_LAKH("+13000dh");
